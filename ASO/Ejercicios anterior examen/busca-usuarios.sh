...
# Inicializamos un contador para recorrer los parámetros
index=1

# Mientras queden parámetros, procesamos uno por uno
while [ $index -le $# ]; do
    user="${!index}"  # Obtener el parámetro actual
    ...
    # Incrementamos el índice para procesar el siguiente parámetro
    ((index++))
done
